function []=thecurve3_hole(curvecell,filenamecell,clascell,filedisplay,minopt,logopt,clasopt,axesnum,xmin,xmax,ymin,ymax,modedisplay,fileindex,modeindex,picpoint)
%BWS
%August 2000
