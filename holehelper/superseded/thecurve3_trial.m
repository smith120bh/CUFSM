function []=thecurve3_trial(curvecell,filenamecell,clascell,filedisplay,minopt,logopt,clasopt,xmin,xmax,ymin,ymax,modedisplay,fileindex,modeindex,picpoint)
%BWS
%August 2000
