function [A,xc,yc,Ix,Iy,Ixy,theta,I1,I2,J,xs,ys,Cw,B1,B2,wn] = cutwp_prop2_for_hole(coord,ends)
...
if strcmp(section,'close')
    ...
    xs = NaN; ys = NaN;
%     Cw = NaN;
    B1 = NaN; B2 = NaN; Pe = NaN; dcoord = NaN; wn=NaN;
...
elseif strcmp(section,'arbitrary')
    % compute the torsional constant based on an open-section
    J = sum(L.*t.^3)/3;
    xs = NaN; ys = NaN; 
%     Cw = NaN;
    B1 = NaN; B2 = NaN; Pe = NaN; dcoord = NaN; wn=NaN;
