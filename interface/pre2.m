...
title_spring=uicontrol(fig,...
	'Style','text','units','normalized',...
	'HorizontalAlignment','Left','TooltipString','Note springs under active development',...
    'FontName','Arial','FontSize',14,'ForegroundColor',[128/256 128/256 128/256],...
   'Position',[0.28 0.14 0.34 0.03],...
   'String','Springs');
txt_springs=uicontrol(fig,...
	'Style','text','units','normalized',...
	'Position',[0.28 0.11 0.34 0.03],...
	'HorizontalAlignment','Left','ForegroundColor',[128/256 128/256 128/256],...
